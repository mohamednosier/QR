...
//        list_latitiude.add(location.getLatitude());
//        list_longitude.add(location.getLongitude());
//        list_status.add("inroute");
//        Log.d("Location Manager", "onLocationChanged: latitude  c "+location.getLatitude()+ " Longitude  c  "+location.getLongitude());


//        Point originPoint = Point.fromLngLat(location.getLongitude(), location.getLatitude());
//        Point destinationPoint = Point.fromLngLat(31.198735, 30.822643);
...
//        MainActivity.getRoute(originPoint, destinationPoint);
    }
    @Override
